...
import { t as require_jquery } from "./jquery.js";
//#region ../node_modules/.pnpm/popper.js@1.16.1/node_modules/popper.js/dist/esm/popper.js
...
//#endregion
//#region ../node_modules/.pnpm/bootstrap@4.6.2_jquery@3.7.1_popper.js@1.16.1/node_modules/bootstrap/dist/js/bootstrap.js
var require_bootstrap = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	/*!
	...
	*/
	(function(global, factory) {
		typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require_jquery(), (init_popper(), __toCommonJS(popper_exports))) : typeof define === "function" && define.amd ? define([
			"exports",
			"jquery",
			"popper.js"
		], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.bootstrap = {}, global.jQuery, global.Popper));
	})(exports, (function(exports$1, $, Popper) {
		"use strict";
		...
		function getSpecialTransitionEndEvent() {
			return {
				...
				handle: function handle(event) {
					if ($__default["default"](event.target).is(this)) return event.handleObj.handler.apply(this, arguments);
				}
			};
		}
		...
		*/
		var Util = {
			...
			getTransitionDurationFromElement: function getTransitionDurationFromElement(element) {
				...
				if (!parseFloat(transitionDuration) && !parseFloat(transitionDelay)) return 0;
			...
			jQueryDetection: function jQueryDetection() {
				...
				var ltMajor = 2;
				var minMinor = 9;
				if (version[0] < ltMajor && version[1] < minMinor || version[0] === minMajor && version[1] === minMinor && version[2] < 1 || version[0] >= 4) throw new Error("Bootstrap's JavaScript requires at least jQuery v1.9.1 but less than v4.0.0");
			}
		};
		...
		*/
		var Alert = /* @__PURE__ */ function() {
			...
			_proto.close = function close(element) {
				...
				if (this._triggerCloseEvent(rootElement).isDefaultPrevented()) return;
		...
		var Button = /* @__PURE__ */ function() {
			...
			_proto.toggle = function toggle() {
				...
				if (rootElement) {
					...
					if (input) {
						if (input.type === "radio") if (input.checked && this._element.classList.contains(CLASS_NAME_ACTIVE$3)) triggerChangeEvent = false;
						else {
		...
		*/
		$__default["default"](document).on(EVENT_CLICK_DATA_API$5, SELECTOR_DATA_TOGGLE_CARROT, function(event) {
			...
			if (!button || button.hasAttribute("disabled") || button.classList.contains("disabled")) event.preventDefault();
			else {
		...
		*/
		var Carousel = /* @__PURE__ */ function() {
			...
			_proto._getItemByDirection = function _getItemByDirection(direction, activeElement) {
				...
				if ((isPrevDirection && activeIndex === 0 || isNextDirection && activeIndex === lastItemIndex) && !this._config.wrap) return activeElement;
			...
			_proto._slide = function _slide(direction, element) {
				...
				if (this._triggerSlideEvent(nextElement, eventDirectionName).isDefaultPrevented()) return;
		...
		var Collapse = /* @__PURE__ */ function() {
			...
			_proto.hide = function hide() {
				...
				if (triggerArrayLength > 0) for (var i = 0; i < triggerArrayLength; i++) {
					...
					if (selector !== null) {
						if (!$__default["default"]([].slice.call(document.querySelectorAll(selector))).hasClass(CLASS_NAME_SHOW$6)) $__default["default"](trigger).addClass(CLASS_NAME_COLLAPSED).attr("aria-expanded", false);
					}
				}
				this.setTransitioning(true);
				var complete = function complete() {
			...
			_proto._getDimension = function _getDimension() {
				return $__default["default"](this._element).hasClass(DIMENSION_WIDTH) ? DIMENSION_WIDTH : DIMENSION_HEIGHT;
			};
		...
		*/
		$__default["default"](document).on(EVENT_CLICK_DATA_API$3, SELECTOR_DATA_TOGGLE$3, function(event) {
			...
			$__default["default"](selectors).each(function() {
				...
				var config = $target.data(DATA_KEY$7) ? "toggle" : $trigger.data();
		...
		*/
		var Modal = /* @__PURE__ */ function() {
			...
			_proto.show = function show(relatedTarget) {
				...
				var showEvent = $__default["default"].Event(EVENT_SHOW$2, { relatedTarget });
			...
			_proto._showElement = function _showElement(relatedTarget) {
				...
				var shownEvent = $__default["default"].Event(EVENT_SHOWN$2, { relatedTarget });
		...
		*/
		...
		function allowedAttribute(attr, allowedAttributeList) {
			...
			for (var i = 0, len = regExp.length; i < len; i++) if (regExp[i].test(attrName)) return true;
			return false;
		}
		function sanitizeHtml(unsafeHtml, whiteList, sanitizeFn) {
			...
			for (var i = 0, len = elements.length; i < len; i++) if (_loop(i) === "continue") continue;
		...
		*/
		...
		var DefaultType$2 = _extends({}, Tooltip.DefaultType, { content: "(string|element|function)" });
		var Event = {
		...
		*/
		var ScrollSpy = /* @__PURE__ */ function() {
			...
			_proto.refresh = function refresh() {
				...
				[].slice.call(document.querySelectorAll(this._selector)).map(function(element) {
					...
					if (target) {
						...
						if (targetBCR.width || targetBCR.height) return [$__default["default"](target)[offsetMethod]().top + offsetBase, targetSelector];
					}
					return null;
			...
			_proto._process = function _process() {
				...
				for (var i = this._offsets.length; i--;) if (this._activeTarget !== this._targets[i] && scrollTop >= this._offsets[i] && (typeof this._offsets[i + 1] === "undefined" || scrollTop < this._offsets[i + 1])) this._activate(this._targets[i]);
			};
		...
		*/
		var Tab = /* @__PURE__ */ function() {
			...
			_proto._activate = function _activate(element, container, callback) {
				var _this2 = this;
				var active = (container && (container.nodeName === "UL" || container.nodeName === "OL") ? $__default["default"](container).find(SELECTOR_ACTIVE_UL) : $__default["default"](container).children(SELECTOR_ACTIVE))[0];
		...
		*/
		...
		exports$1.Alert = Alert;
		exports$1.Button = Button;
		exports$1.Carousel = Carousel;
		exports$1.Collapse = Collapse;
		exports$1.Dropdown = Dropdown;
		exports$1.Modal = Modal;
		exports$1.Popover = Popover;
		exports$1.Scrollspy = ScrollSpy;
		exports$1.Tab = Tab;
		exports$1.Toast = Toast;
